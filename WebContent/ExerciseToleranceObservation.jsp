...
<title>Enter your exercise tolerance here !</title>
...
<body>
<center>
<h2>Enter your Exercise Tolerance details</h2><br/>
<div style="color:#FF0000" id='et_form_et_num_errorloc'></div>
<div style="color:#FF0000" id='et_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_sec_errorloc' ></div>
<div style="color:#FF0000" id='et_form_obv_ampm_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("et_form");
 
 frmvalidator.addValidation("et_num","req","Number of steps cannot be left blank");
 frmvalidator.addValidation("et_num","num","Number of steps can only be numeric");
