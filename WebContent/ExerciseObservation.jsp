...
<title>Enter exercise details here!</title>
...
<body>
<center>
<h2>Enter your exercise details</h2><br/>
<div style="color:#FF0000" id='ex_form_ex_kind_errorloc'></div>
<div style="color:#FF0000" id='ex_form_ex_duration_errorloc'></div>
<div style="color:#FF0000" id='ex_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='ex_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='ex_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='ex_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='ex_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='ex_form_obv_sec_errorloc' ></div>
...
Duration:<input type="text" name="ex_duration"/>(in minutes)<br/><br/>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("ex_form");
 
 frmvalidator.addValidation("ex_kind","req","Exercise type cannot be left blank");
 
 frmvalidator.addValidation("ex_duration","req","Duration cannot be left blank");
 
 frmvalidator.addValidation("ex_duration","num","Duration can only be numeric");
