...
<title>Enter your BP here !</title>
...
<body>
<center>
<h2>Enter your Blood Pressure details</h2><br/>
<div style="color:#FF0000" id='bp_form_bp_sys_errorloc'></div>
<div style="color:#FF0000" id='bp_form_bp_dia_errorloc'></div>
<div style="color:#FF0000" id='bp_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='bp_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='bp_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='bp_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='bp_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='bp_form_obv_sec_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("bp_form");
 
 frmvalidator.addValidation("bp_sys","req","Systolic BP cannot be left blank");
 frmvalidator.addValidation("bp_dia","req","Diastolic BP cannot be left blank");
 frmvalidator.addValidation("bp_sys","num","Systolic BP can only be numeric");
 
 frmvalidator.addValidation("bp_dia","num","Diastolic BP can only be numeric");
