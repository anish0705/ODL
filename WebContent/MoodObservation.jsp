...
<title>Enter your mood here !</title>
...
<body>
<center>
<h2>Enter your Mood details</h2><br/>
<div style="color:#FF0000" id='m_form_m_value_errorloc'></div>
<div style="color:#FF0000" id='m_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='m_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='m_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='m_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='m_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='m_form_obv_sec_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("m_form");
 
 frmvalidator.addValidation("m_value","selone","Select a mood value");
