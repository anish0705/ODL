...
<body>
	...
	else
	{
	 ...
	 int i= st1.executeUpdate("insert into patients(pname,pdob,psex,p_pubstatus,pc_id,p_password,p_street,p_city,p_state,p_country,p_zipcode,p_age,patientid) values('"+patientName+"','"+tempDate+"','"+sex+"','"+status+"',"+pc_id+",'"+password+"','"+street+"','"+city+"','"+state+"','"+country+"',"+zipcode+","+age+",'"+patient_id+"')");
	 rs.close();
