...
<title>Enter your oxygen saturation level here !</title>
...
<body>
<center>
<h2>Enter your Oxygen Saturation details</h2><br/>
<div style="color:#FF0000" id='os_form_os_amt_errorloc'></div>
<div style="color:#FF0000" id='os_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='os_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='os_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='os_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='os_form_obv_min_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("os_form");
 
 frmvalidator.addValidation("os_amt","req","Amount cannot be left blank");
 frmvalidator.addValidation("os_amt","num","Oxygen stauration can only be numeric");
