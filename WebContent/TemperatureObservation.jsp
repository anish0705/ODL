...
<title>Enter your temperature here !</title>
...
<body>
<center>
<h2>Enter your temperature details</h2><br/>
<div style="color:#FF0000" id='temp_form_temp_amt_errorloc'></div>
<div style="color:#FF0000" id='temp_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_sec_errorloc' ></div>
<div style="color:#FF0000" id='temp_form_obv_ampm_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("temp_form");
 
 frmvalidator.addValidation("temp_amt","req","Temperature cannot be left blank");
 frmvalidator.addValidation("temp_amt","num","Temperature can only be numeric");
