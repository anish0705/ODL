...
<title>Enter about your contractions here !</title>
...
<body>
<center>
<h2>Enter your Contraction details</h2><br/>
<div style="color:#FF0000" id='c_form_c_frequency_errorloc'></div>
<div style="color:#FF0000" id='c_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_sec_errorloc' ></div>
<div style="color:#FF0000" id='c_form_obv_ampm_errorloc' ></div>
...
<script type="text/javascript">
 ...
 frmvalidator.addValidation("c_frequency","req","Frequency cannot be left blank");
 frmvalidator.addValidation("c_frequency","num","Frequency can only be numeric");
