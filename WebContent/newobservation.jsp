...
<center>
 ...
 <%
 	...
 	ResultSet rs_gen = st_gen.executeQuery("select ot_id from observationtype where ot_id<>1 and ot_id<>2 and ot_id<>3 and ot_id<>8 and oc_id =4");
 ...
 <%
 	for(int b=0;b<a;b++)
 	{
 		...
 		case 1: // HIV
 		 ...
 		 ResultSet rs2 = st2.executeQuery("select ot_id from type_belongs_to_class where pc_id=1 and ot_id<>10 and ot_id<>1 and ot_id <>2 and ot_id<>3 and ot_id<>8");
        ...
        int[] copd_types = new int[10];
 		 ...
 		 ResultSet rs5 = st5.executeQuery("select ot_id from type_belongs_to_class where pc_id=4 and ot_id<>5 and ot_id<>6 and ot_id<>1 and ot_id <>2 and ot_id<>3 and ot_id<>8 ");
