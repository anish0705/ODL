...
<title>Enter your weight details here !</title>
...
<body>
<center>
<h2>Enter your weight details</h2><br/>
<div style="color:#FF0000" id='weight_form_weight_amt_errorloc'></div>
<div style="color:#FF0000" id='weight_form_obv_day_errorloc' ></div>
<div style="color:#FF0000" id='weight_form_obv_month_errorloc' ></div>
<div style="color:#FF0000" id='weight_form_obv_year_errorloc' ></div>
<div style="color:#FF0000" id='weight_form_obv_hr_errorloc' ></div>
<div style="color:#FF0000" id='weight_form_obv_min_errorloc' ></div>
<div style="color:#FF0000" id='weight_form_obv_sec_errorloc' ></div>
...
<script type="text/javascript">
 var frmvalidator  = new Validator("weight_form");
 
 frmvalidator.addValidation("weight_amt","req","Weight cannot be left blank");
 frmvalidator.addValidation("weight_amt","num","Weight can only be numeric");
